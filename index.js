...
choices.forEach((choice) => {
    ...
    btn.addEventListener('click', () => {
        document.querySelectorAll('.choices__box').forEach((otherBox) => {
            if (otherBox !== box && otherBox.classList.contains('choices__box_open')) {
                otherBox.classList.remove('choices__box_open');
            }
        });
